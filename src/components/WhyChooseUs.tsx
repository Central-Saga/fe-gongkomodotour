  ...
  return (
    <section className="py-0 bg-white m-0 w-full">
      <div className="flex flex-col md:flex-row">
        {/* Kolom Kiri: 4 Kartu dengan Margin Kanan */}
        <div className="flex-1 max-w-[1280px] mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6 p-10 md:mr-6">
          {reasons.map((reason, index) => (
            <div
              key={index}
              className="bg-white p-4 shadow-md rounded-lg border border-gray-100"
            >
              <h3
        ...
        {/* Kolom Kanan: Gambar dengan Overlay, Menempel ke Kanan */}
        <div className="relative w-full md:w-1/3 h-auto m-0 p-0">
          <Image
            ...
            objectFit="cover" // Menjaga rasio aspekkiri
          />
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center rounded-l-lg rounded-r-none">
