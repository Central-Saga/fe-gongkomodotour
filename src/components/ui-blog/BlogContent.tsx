      ...
      <div className="latest-post py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {blogPosts.slice(0, 3).map((post) => (
            ...
            <div className="flex justify-between items-center mt-4 text-sm text-gray-500">
              {/* Icon for Uploaded by */}
              <div className="flex items-center gap-1">
                <FaUser className="w-4 h-4" /> {/* Ikon manusia setengah badan */}
                <span>Uploaded by: {post.author}</span>
              </div>
              {/* Icon for Date */}
              <div className="flex items-center gap-1">
                <FaRegCalendarAlt className="w-4 h-4" /> {/* Ikon kalender */}
                <span>{post.date}</span>
              </div>
            </div>
          </div>
        ...
        <div className="visiting-flores py-12">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/blog/viewall/visiting-flores" className="text-yellow-500 font-semibold">
              View All
            </Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="traveling-tips py-12">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/blog/viewall/traveling-tips" className="text-yellow-500 font-semibold">
              View All
            </Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
