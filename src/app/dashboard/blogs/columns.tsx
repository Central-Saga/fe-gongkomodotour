...
const ActionsCell = ({ row }: { row: { original: Blog } }) => {
...
export const columns = (): ColumnDef<Blog>[] => [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="min-w-[150px]">{row.original.author.name}</div>
    ),
  },
  {
    accessorKey: "status",
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="min-w-[100px]">
          <Badge className={`${status === "published" ? "bg-emerald-500" : "bg-red-500"} text-white`}>
